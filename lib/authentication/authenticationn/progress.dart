...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void nextScreen() {
    if (formValidity[currentIndex]) {
      // Only allow next if the current form is valid
      ...
      // Show some error message if the form is not filled correctly
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (value) {
                  setState(() {
                    _isValid = value.isNotEmpty; // Name should not be empty
                    // Update validity state for NameInput screen
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          ...
          // Update validity state for GenderInput screen
          (context.findAncestorStateOfType<_OnboardingScreenState>()!)
              .formValidity[1] = true;
        });
      },
            ...
            NumberPicker(
              ...
              onChanged: (value) {
                setState(() {
                  weight = value;
                  _isValid = weight >=
                      30; // Weight must be valid (greater than or equal to 30)
                  // Update form validity for the WeightInput screen
                  (context.findAncestorStateOfType<_OnboardingScreenState>()!)
          ...
          children: [
            ...
            NumberPicker(
              ...
              onChanged: (value) {
                setState(() {
                  widget.height = value;
                  _isValid = widget.height >= 100 &&
                      widget.height <=
                          250; // Height should be within a valid range
                  // Update form validity for the HeightInput screen
                  (context.findAncestorStateOfType<_OnboardingScreenState>()!)
