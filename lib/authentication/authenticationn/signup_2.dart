...
Future<void> _handleGoogleSignIn(BuildContext context) async {
  try {
    ...
    if (registrationStatus == 'success') {
      if (!_dialogShown) {
        await _showSuccessDialog(context, "SignUp Successful!!", "You have successfully Signed Up");
        setState(() {
          _dialogShown = true;
        });
      }
      ...
      // Show generic error message if registration status is not 'success' or 'user_exists'
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    // If the error has more detailed information (e.g., from exceptions), display it
