...
//                   child: ExpansionTile(
//                     title: Text(
//                         "Service Name: ${serviceModel.title}\nUUID: ${serviceModel.uuid}\nType: ${serviceModel.type}",
//                         style: TextStyle(
//                             fontSize: 18, fontWeight: FontWeight.bold)),
//                     children: [
//                       Column(
//                         children: serviceModel.characteristics.map((charModel) {
//                           return _buildCharacteristicCard(charModel, serviceModel);
//                         }).toList(),
//                       ),
//                     ],
//                   ),
...
//   Widget _buildCharacteristicCard(BluetoothCharacteristicModel charModel, BluetoothServiceModel serviceModel) {
//     return Card(
//       elevation: 4.0,
//       child: Padding(
//         padding: const EdgeInsets.all(8.0),
//         child: ExpansionTile(
//           title: Text(
//               "Service Name: ${serviceModel.title}\nService UUID: ${serviceModel.uuid}\nProperties: ${charModel.properties}",
//               style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
//           children: [
//             Row(
//               children: [
