...
//           children: [
//             _buildCharacteristicDetails(charModel),
//           ],
//         ),
//       ),
//     );
...
//   Widget _buildCharacteristicDetails(BluetoothCharacteristicModel charModel) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         if (charModel.value != null) 
//           Text("Value: ${charModel.value}"),
...
//           ElevatedButton(
//             onPressed: () async {
//               // Implement write operation if required
//               // Example: await _writeCharacteristic(charModel.characteristic, value);
//             },
