    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
              "assets/HomeDash/myplanfor.jpeg"), // Replace with your background image
          fit: BoxFit.cover,
        ),
...
// top resource card 
  ...
  Widget _buildResourceCard(
    ...
    return Container(
      width: 180, // Adjusted width to make the cards more compact
      margin: EdgeInsets.symmetric(
          horizontal: 6.0, vertical: 12.0), // Reduced gap between cards
      decoration: BoxDecoration(
        borderRadius:
            BorderRadius.circular(20), // More rounded corners for a modern look
        boxShadow: [
          BoxShadow(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height: 10), // Increased space between title and kcal/time
                ...
                Row(
                  ...
                  children: [
                    Icon(Icons.local_fire_department,
                        ...
                        size: 24), // Larger kcal icon
                    SizedBox(width: 8), // More space between icon and kcal text
                    Text(
                    ...
                    SizedBox(width: 12), // More space between kcal and time
                    Icon(Icons.access_time,
                        color: Colors.lightBlueAccent,
                        size: 24), // Larger time icon
                    SizedBox(width: 8), // More space between icon and time text
                    Text(
